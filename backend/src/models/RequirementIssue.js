...
const definition = {
  fields: {
    ...
    suggestedMerge: { type: String, default: '' },
    suggestedResolution: { type: String, default: '' },
    clarificationQuestion: { type: String, default: '' },
    status: { type: String, enum: ['OPEN', 'RESOLVED', 'IGNORED', 'MERGED', 'KEPT_BOTH'], default: 'OPEN' },
    resolutionType: { type: String, enum: ['KEEP_BOTH', 'MERGE', 'EDIT', 'MARK_RESOLVED', 'IGNORED', 'NONE'], default: 'NONE' },
